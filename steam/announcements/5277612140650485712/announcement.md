...
*Added a lot of scripting features that are now available for modders. Check out the [Lua Script API](http://scrapmechanic.com/api/index.html) for more info.
